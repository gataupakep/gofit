                        ...
                        <form @submit.prevent="store">
                            ...
                            <div class="form-group mb-3"> <label class="form-label">Hari</label> 
                                <select
                                    ...
                                    >
                                    <option value="" hidden>Masukan Hari</option>
                            ...
                            <div class="form-group mb-3"> <label class="form-label">Sesi</label> 
                                <select
                                    ...
                                    >
                                    <option value="" hidden>Masukan Sesi</option>
                            ...
                            <div class="form-group mb-3"> <label class="form-label">Jam Mulai</label>
                                <select
                                    ...
                                    >
                                    <option value="" hidden>Masukan Waktu Mulai Kelas</option>
                            ...
                            <div class="form-group mb-3"> <label class="form-label">Jam Selesai</label>
                                <select
                                    ...
                                    >
                                    <option value="" hidden>Masukan Waktu Selesai Kelas</option>
                                    <option value="09:30:00" >09:30:00</option>
...
export default {
    setup() {
        ...
        function store() { 
            ...
            axios.post('https://jesso.ppcdeveloper.com/api/jadwalUmum', { 
                ...
                waktu_selesai : waktu_selesai,
                 ...
                 router.push({ name: 'jadwalUmum.index' }) }).catch(error => { 

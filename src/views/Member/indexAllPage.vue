        ...
        <div class="card border-0 rounded shadow">
          <div class="card-body">
            ...
            <router-link
              ...
              >SHOW EXP NOW DATA MEMBER ONLY</router-link
            >
...
export default {
  setup() {
      ...
      swalWithBootstrapButtons
        ...
        .then((result) => {
          if (result.isConfirmed) {
            axios
              .delete(`https://jesso.ppcdeveloper.com/api/member/${id}`)
              .then(() => {
                //splice departemen
    ...
    function memberResetPassword(id) {
      axios
        .put(`https://jesso.ppcdeveloper.com/api/member/${id}`)
        .then(() => {
          //splice member
    ...
    function downloadPDF(id_member, nama_member, alamat, telepon) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          Swal.fire(
            "Struk telah dicetak!",
            "Struk will be on your computer immediately.",
            "success"
          );

    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card border-0 rounded shadow">
          <div class="card-body">
            <router-link
              :to="{ name: 'absenInstruktur.belumDikonfirmasi' }"
              class="btn btn-md btn-success"
              >Tampilkan Data Izin yang Belum Dikonfirmasi</router-link
            >
            <table class="table table-striped table-bordered mt-4">
              ...
              <tbody
                v-for="(absenInstruktur, id) in absen_instrukturs"
                :key="id"
              >
                <tr v-if="absenInstruktur.confirm == 'Dikonfirmasi'">
                  <td>{{ absenInstruktur.instruktur.nama_instruktur }}</td>
                  <td>
                    {{ absenInstruktur.instrukturpengganti.nama_instruktur }}
                  </td>
